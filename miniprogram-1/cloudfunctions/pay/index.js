...
const appId = 'wxfe3fbbd67a4e1a13'           // 小程序appid
const mchId = '1500821891'                   // 商户号
const key = '****************************';   // 商户密钥
...
exports.main = async (event, context) => {
  ...
  const tradeNo = `{"oTKZY5B - zi1wErQMJmAQvRXIQwv8".substr(-5)}-${curTime}`;//`${event.userInfo.openId.substr(-5)}-${curTime}`; // 生成订单号
  ...
  let orderParam = {
    ...
    out_trade_no,
    total_fee,
    openid: "oTKZY5B - zi1wErQMJmAQvRXIQwv8",//event.userInfo.openId,
    trade_type: 'JSAPI',
